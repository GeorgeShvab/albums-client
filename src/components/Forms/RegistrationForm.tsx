...
import { fetchLog, fetchReg } from '../../redux/slices/auth'
import { LoginFormEvent, RegFormEvent } from '../../types'
...
const RegistrationFrom = (): ReactElement => {
    ...
    const handleSubmit = async (e: RegFormEvent) => {
        try {
            e.preventDefault()
            ...
            if (!name.trim()) {
                setErrors((prev) => [
                    ...prev,
                    {
                        msg: 'Всі поля повинні бути заповнені',
                        param: 'name',
                    },
                ])
            }
            ...
            if (!nameValidator(name)) {
                setErrors((prev) => [
                    ...prev,
                    {
                        msg: "Ім'я повинно містити хоча б 2 букви та не мати більше 30 букв",
                        param: 'name',
                    },
                ])
            }
            ...
            if (!passwordValidator(password)) {
                setErrors((prev) => [
                    ...prev,
                    {
                        msg: 'Пароль повинен містити хоча б 6 символів і мати не більше 60 символів',
                        param: 'password',
                    },
                ])
            }
